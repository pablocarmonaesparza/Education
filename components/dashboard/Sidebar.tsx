    ...
    <aside className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col transition-colors">
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-700">
        <Link href="/dashboard" className="flex items-center gap-2">
          ...
          <div>
            <div className="font-bold text-gray-900 dark:text-white">IA & Automatización</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">by Beta AI</div>
          </div>
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
        ...
        <button
          ...
          disabled={loading}
          className="flex items-center gap-3 w-full px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors disabled:opacity-50"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
          </svg>
          <span className="font-medium">{loading ? 'Saliendo...' : 'Cerrar Sesión'}</span>
        </button>
      </div>
    </aside>
  );
