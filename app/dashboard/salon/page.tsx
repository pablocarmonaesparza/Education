            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-3 flex-shrink-0">
                ...
                <button
                  ...
                  className={`group h-10 rounded-full flex items-center justify-center overflow-hidden ${
                ...
                >
                  <span className="text-sm font-medium whitespace-nowrap overflow-hidden opacity-0 group-hover:opacity-100 mr-0 group-hover:mr-2 w-0 group-hover:w-auto">
                    Completado
                  </span>
