  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section className="flex-grow container mx-auto px-4 py-8 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="text-4xl font-bold mb-4">¡Pago con Mercado Pago Cancelado!</h1>
        <p className="text-lg text-gray-700 mb-8">
          Tu proceso de pago con Mercado Pago ha sido cancelado. Puedes intentarlo de nuevo.
        </p>
        <Link href="/pricing" className="px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700">
          Volver a Precios
        </Link>
      </section>
      <Footer />
